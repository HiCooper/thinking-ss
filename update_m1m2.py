...
运行（用 skill 自带的 akshare 虚拟环境，系统 python 没装 akshare）：
    /Users/xueancao/Projects/QoderProjects/agents-silky/skills/akshare-data/.venv/bin/python update_m1m2.py [月数]
...
out = (
    "// 自动生成：近 {} 个月货币供应量同比（%）。\n"
    "// 运行 `/Users/xueancao/Projects/QoderProjects/agents-silky/skills/akshare-data/.venv/bin/python update_m1m2.py` 重新生成，勿手改。\n"
    "window.M1M2_DATA = [\n{}\n];\n"
